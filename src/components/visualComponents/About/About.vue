    ...
    <section class="flex flex-col md:flex-row">
        <div class="flex flex-col items-center flex-1">
            ...
            <p class="text-lg font-bold text-dark leading-6 font-mono w-3/4 mb-10 md:mb-0">
                ...
                university
                I first determined my profession as an Interface Designer, but with the algorithm course I took last
                year,
                I met the software. I develop myself both in software and design.
            </p>
        </div>
        <div class="flex-1">
